if(!isPCMode()){
    console.log("is Not PC-----"+isPCMode());
}else{
    console.log("isPC-----"+isPCMode());
    try {
        ...
        $.ajax({url: "/live2d/waifu-tips.js?v=1.4.2", dataType:"script", cache: true, success: function() {
            $.ajax({url: "/live2d/live2d.js?v=1.0.5", dataType:"script", cache: true, success: function() {
                ...
                live2d_settings['modelId'] = 3;                  // 默认模型 ID 1,6
                live2d_settings['modelTexturesId'] = 76;          // 默认材质 ID 6-3,7,2,1-87,1-42,1-2兔子，1-81，1-30羊
